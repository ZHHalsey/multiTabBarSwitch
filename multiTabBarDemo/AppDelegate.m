...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // TabBar为one
    TabBarControllerOne *tabBarOneVC = [[TabBarControllerOne alloc] init];
    [self.window setRootViewController:tabBarOneVC];
    ...
    //    [self.window setRootViewController:tabBabTwoVC];
